...
import { upsertMenuItemAdmin, type ActionState } from "@/app/admin/actions";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export function AdminMenuItemDialog({ restaurantId, item }: { restaurantId: string; item?: MenuItem }) {
  const [open, setOpen] = useState(false);
  const [state, formAction] = useActionState<ActionState, FormData>(
    upsertMenuItemAdmin.bind(null, restaurantId),
    undefined
  );
